...
<body>
    <main>
        <article>
            ...
            if ($regError)   echo '<div class="alert alert-error">'   . htmlspecialchars($regError['message'])   . '</div>';
            if ($regSuccess) echo '<div class="alert alert-success">' . htmlspecialchars($regSuccess['message']) . '</div>';
            ?>
            ...
            <div class="form-links">
                <small>Already have an account? <a href="?page=auth&action=login">Login here</a></small>
            </div>
        </article>
    </main>
